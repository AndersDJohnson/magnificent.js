(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['google-analytics-js'], function (gaTrack) {
        return (root[name] = factory(root, gaTrack));
    });
  } else if (typeof exports === 'object') {
    module.exports = factory(root, require('google-analytics-js'));
  } else {
    root[name] = factory(root, root.gaTrack);
  }
}(this, function (root, gaTrack) {
