...
* First, any dependencies of any main files you need:
  ...
  * [google-analytics-js](https://github.com/AndersDJohnson/google-analytics-js)@[^0.1.0](https://github.com/AndersDJohnson/google-analytics-js/tree/0.1.1)
    * [bower_components/google-analytics-js/gajs.js](https://raw.githubusercontent.com/AndersDJohnson/google-analytics-js/0.1.1/gajs.js)
  ...
  * [prevent-ghost-click](https://github.com/AndersDJohnson/prevent-ghost-click.js)@[~0.0.0](https://github.com/AndersDJohnson/prevent-ghost-click.js/tree/v0.0.0)
    * [bower_components/prevent-ghost-click/PreventGhostClick.js](https://raw.githubusercontent.com/AndersDJohnson/prevent-ghost-click.js/v0.0.0/PreventGhostClick.js)
      * Optional: For touch interaction (pan, pinch).
