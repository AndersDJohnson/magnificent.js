...
(function (root) {
  ...
  function Area ($element, options) {
    ...
    self.options.eventNamespace = self.options.eventNamespace || 'zoom';
  ...
  Zoom.prototype._init = function() {
    ...
    var id = self.$element.attr('data-zoom');

    // Viewport
    var viewportSelector = '[data-zoom-viewport="' + id + '"]';
  ...
  Zoom.prototype.instance = function () {
    return this;
  }

  Zoom.prototype.layout = function () {
    var self = this;
    self.area.layout();
    self.viewport.layout();
    if (self.lens) {
