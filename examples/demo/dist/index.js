...
require('../../src/js/mag-jquery');

require('../../src/js/mag-control');

require('jquery.threedubmedia');

exports['default'] = (function () {
	var $host;
	var $controls;

	$host = _jquery2['default']('[mag-thumb="inner"]');
	$host.mag({
		toggle: true
	});

	$controls = _jquery2['default']('[mag-ctrl="inner"]');
	$controls.magCtrl({
		mag: $host
	});
})();
...
(function () {
	...
	$host = _jquery2['default']('[mag-thumb="inner-inline"]');
	$host.mag();
})();
...
(function () {
	...
	$host = _jquery2['default']('[mag-thumb="outer"]');
	$host.mag({
		mode: 'outer',
		ratio: 1 / 1.6
	});
...
(function () {
	...
	$host = _jquery2['default']('[mag-thumb="outer-drag"]');
	$host.mag({
		mode: 'outer',
		position: 'drag',
		toggle: false
...
(function () {
	...
	$host = _jquery2['default']('[mag-thumb="drag"]');
	$host.mag({
		position: 'drag',
		toggle: false
	});

	$hudLeft = _jquery2['default']('<div class="mag-eg-hud mag-eg-hud-left"></div>');
	$hudLeft.appendTo($host.parent());

	$hudRight = _jquery2['default']('<div class="mag-eg-hud mag-eg-hud-right"></div>');
	$hudRight.appendTo($host.parent());

	var toPerc = function toPerc(p) {
		return (p * 100).toFixed(1) + '%';
	};

	$host.on('compute', function (e) {
		var mag = _jquery2['default'](this).data('mag');
		var m = mag.model;
		$hudLeft.html('<div>' + m.zoom.toFixed(1) + 'x</div>');
		$hudRight.html('<div>(' + toPerc(m.focus.x) + ', ' + toPerc(m.focus.y) + ')</div>');
	});
})();
...
(function () {
	...
	$host = _jquery2['default']('[mag-thumb="controls"]');
	$host.mag({
		toggle: false,
		position: false
	});

	$controls = _jquery2['default']('[mag-ctrl="controls"]');
	$controls.magCtrl({
		mag: $host
	});
})();
...
},{"../../src/js/mag-control":5,"../../src/js/mag-jquery":6,"jquery":4,"jquery.threedubmedia":1}],3:[function(require,module,exports){
/**
...
exports['default'] = (function () {
  ...
  var MagnificentControl = function MagnificentControl(element, options) {
    this.element = _node_modulesJqueryDistJquery2['default'](element);
    this.options = _node_modulesJqueryDistJquery2['default'].extend(true, {}, this.options, options);
    this._init();
  };
  ...
  MagnificentControl.prototype._init = function () {
    ...
    this.$mag = _node_modulesJqueryDistJquery2['default'](this.options.mag);
    ...
    $el.find('[mag-ctrl-zoom-by]').on('click', function () {
      var zoomBy = _node_modulesJqueryDistJquery2['default'].parseJSON(_node_modulesJqueryDistJquery2['default'](this).attr('mag-ctrl-zoom-by'));
      magInst.zoomBy(zoomBy);
    });

    $el.find('[mag-ctrl-move-by-x], [mag-ctrl-move-by-y]').on('click', function () {
      var x = _node_modulesJqueryDistJquery2['default'](this).attr('mag-ctrl-move-by-x');
      if (x != null) {
        x = _node_modulesJqueryDistJquery2['default'].parseJSON(x);
      }
      var y = _node_modulesJqueryDistJquery2['default'](this).attr('mag-ctrl-move-by-y');
      if (y != null) {
        y = _node_modulesJqueryDistJquery2['default'].parseJSON(y);
      }
      var moveBy = {
        x: x,
        y: y
  ...
  _node_modulesJqueryDistJquery2['default'].bridget('magCtrl', MagnificentControl);
...
},{"../../node_modules/jquery/dist/jquery":4}],6:[function(require,module,exports){
/**
 * mag-jquery
 */
...
var _mag2 = _interopRequireDefault(_mag);

exports['default'] = (function () {

  _jquery2['default'](':root').addClass('mag-js');

  var normalizeOffsets = function normalizeOffsets(e) {
    var offset = _jquery2['default'](e.target).offset();
    return {
  ...
  var ratioOffsets = function ratioOffsets(e) {
    var normOff = normalizeOffsets(e);
    var $target = _jquery2['default'](e.target);
    return {
  ...
  var ratioOffsetsFor = function ratioOffsetsFor($target, x, y) {
    return {
      x: x / $target.width(),
      y: y / $target.height()
    };
  ...
  var cssPerc = function cssPerc(frac) {
    return frac * 100 + '%';
  };

  var toCSS = function toCSS(pt, mode, id) {
  ...
  var toCSSPosition = function toCSSPosition(pt, id) {
    var css = {};
  ...
  var toCSSTransform2d = function toCSSTransform2d(pt, id) {
    var css = {};
    var left;
    var top;
    var width;
  ...
  var toCSSTransform3d = function toCSSTransform3d(pt, id) {
    var css = {};
    var left;
    var top;
    var width;
    ...
    var transform = '';
    transform += ' scale3d(' + (width !== undefined ? width : 0) + ',' + (height !== undefined ? height : 0) + ',1)';
    transform += ' translate3d(' + (left !== undefined ? left : 0) + ',' + (top !== undefined ? top : 0) + ',0)';
    css.transform = transform;
   ...
   */
  var Magnificent = function Magnificent(element, options) {
    this.element = _jquery2['default'](element);
    this.options = _jquery2['default'].extend(true, {}, this.options, options);
    this._init();
  };
  ...
  Magnificent.prototype._init = function () {
    ...
    if (_jquery2['default'].isFunction(options.toggle)) {
    ...
    var mag = this.mag = new _mag2['default']({
    ...
    var magLazy = this.magLazy = new _mag2['default']({
      zoomMin: options.zoomMin,
      zoomMax: options.zoomMax,
      constrainLens: options.constrainLens,
      constrainZoomed: options.constrainZoomed,
    ...
    if (!options.zoomedContainer) {
      options.zoomedContainer = _jquery2['default']('[mag-zoom="' + that.id + '"]');
    }

    if (options.zoomedContainer) {
      $zoomedContainer = _jquery2['default'](options.zoomedContainer);
    ...
    if (options.showLens) {
      $lens = this.$lens = _jquery2['default']('<div class="mag-lens"></div>');
      $el.append($lens);
    }

    var $noflow = _jquery2['default']('<div class="mag-noflow" mag-theme="' + options.theme + '"></div>');
    $el.append($noflow);
    ...
    var $thumb = _jquery2['default']('<div class="mag-thumb"></div>');
    $thumb.html($thumbChildren);
    $el.append($thumb);

    $zoomed = this.$zoomed = _jquery2['default']('<div class="mag-zoomed"></div>');
    $zoomed.html($zoomedChildren);
    $zoomedContainer.append($zoomed);

    $zoomedContainer.attr('mag-toggle', options.toggle);

    var $zone = _jquery2['default']('<div class="mag-zone"></div>');
    $el.append($zone);
    ...
    var approach = function approach(enabled, thresh, rate, dest, src, props, srcProps) {
      srcProps = srcProps ? srcProps : props;
      if (!_jquery2['default'].isArray(props)) {
        props = [props];
        srcProps = [srcProps];
      }
    ...
    var adjustForMirror = function adjustForMirror(focus) {
  ...
  _jquery2['default'].bridget('mag', Magnificent);
...
},{"./mag":7,"jquery":4,"jquery-bridget":3}],7:[function(require,module,exports){
/**
 * mag
 */
